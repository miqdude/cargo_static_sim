            ...
            if latest_telem is not None and latest_wrench is not None:
                ...
                if F_total > 5.0 and len(history_buffer) == WINDOW_SIZE: 
                    ...
                    with torch.no_grad():
                        ...
                        est_wind_x = float((pinn_model.wind_fx).item())
                        est_wind_y = float((pinn_model.wind_fy).item())
                        est_wind_z = float((pinn_model.wind_fz).item())
                ...
                estimations = {
                    ...
                    "estimated_wind_x": est_wind_x,
                    "estimated_wind_y": est_wind_y,
                    "estimated_wind_z": est_wind_z,
                }
